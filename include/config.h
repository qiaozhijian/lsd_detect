...
public:
    ...
    static bool&    hasRobot()         { return getInstance().has_robot; }
    static bool&    closeLoop()         { return getInstance().close_loop; }
    ...
    static uint8_t &     speedUp()           { return getInstance().speed_up; }
    ...
    static int&     lsdNFeatures()      { return getInstance().lsd_nfeatures; }//# default 300;set to 0 if keeping all lines
